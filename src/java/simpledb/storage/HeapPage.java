    ...
    public HeapPage(HeapPageId id, byte[] data) throws IOException {
        ...
        try{
            ...
            for (int i = 0; i < tuples.length; i++) {
                ...
                if(isSlotUsed(i)) curSlotUsedNum++;
            }
    ...
    */
    ...
    public void insertTuple(Tuple t) throws DbException {
        ...
        for (int i = 0; i < numSlots; i++) {
            if(!isSlotUsed(i)) {
                t.setRecordId(new RecordId(pid, i)); // update
                tuples[i] = t;
                markSlotUsed(i, true);
                return;
            }
    ...
    public TransactionId isDirty() {
        // completed!
        return isDirty ? dirtyTransactionId : null;
    }
    ...
    public int getNumEmptySlots() {
        // completed!
        return numSlots - curSlotUsedNum;
    }
    ...
    public Iterator<Tuple> iterator() {
        ...
        return new Iterator<Tuple>() {
            ...
            public Tuple next() {
                ...
                curNum++;
                while (tupleIdx < tuples.length) {
                    if(isSlotUsed(tupleIdx++)) return tuples[tupleIdx - 1];
                }
